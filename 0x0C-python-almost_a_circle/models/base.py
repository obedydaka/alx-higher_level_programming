...
# -*- coding: utf-8 -*-
"""
Created on Mon 18 Sep 2023 22:45
...
class Base:
    ...
    def to_json_string(list_dictionaries):
        ...
        Attributes:
            list_dictionaries (json): An input of jason list of dictionaries
        Return:
    ...
    def save_to_file(cls, list_objs):
        """
        Writes the json string repressentation list of objects to a file

        Attribute:
            list_objs (list): objects list to save

        Return:
            json objects to save in file
        """
