...
# -*- coding: utf-8 -*-
"""
Created on Mon 18 Sep 2023 23:01
...
class Rectangle(Base):
    ...
    def update(self, *args, **kwargs):
        ...
        Attribute:
            args (list): input arguments to update the rectangle class
            kwargs (dict): input arguments to update the rectangle class
        """
    ...
    def width(self, value):
        ...
        Attribute:
            value (int): value to check if it is an int and gratter than 0
        """
        if type(value) != int:
